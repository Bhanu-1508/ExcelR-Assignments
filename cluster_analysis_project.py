...
kmeans_silhouette = silhouette_score(data_normalized, data_final['KMeans_Cluster'])
agg_silhouette = silhouette_score(data_normalized, data_final['Agglomerative_Cluster'])
# Note: DBSCAN may result in noise points (cluster label -1), so silhouette score might not be meaningful.
